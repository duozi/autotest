...
public class NewGetAll2 {
    private final static Logger logger = LoggerFactory.getLogger(NewGetAll2.class);
    public static StringBuffer result = new StringBuffer();
    public static URLClassLoader loader= ReflectionUtils.addJar("C:\\Users\\xn056839\\Downloads\\user-interface-2.0.0-20160926.085005-12.jar");
